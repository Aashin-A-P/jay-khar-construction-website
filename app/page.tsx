        ...
        <div className="section relative grid min-h-[680px] items-center pt-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <Link className="btn-primary bg-brass text-ink hover:bg-white" href="/contact">
                Start a Project <ArrowRight size={18} />
              </Link>
              <Link className="btn-secondary border-white/25 bg-white/10 text-white hover:border-white hover:text-white" href="/projects">
                View Projects
              </Link>
            </div>
          </div>
