...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link href={`/projects/${project.slug}`} className="group overflow-hidden rounded border border-stone-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lift">
